<nav class="sb-sidenav sb-sidenav-light sb-sidenav-dark accordion" id="sidenavAccordion">
    ...
    <button class="btn btn-link btn-outline-light" id="sidebarToggle" href="#" style="position: absolute;translate: -40px 10px;border-right-color: #ebeef4;"><i class="fas fa-bars"></i></button>

...
class ModeratorAccess extends TestCase
{
    ...
    public function testModeratorCanCreateSceneComment()
    {
    ...
    public function testBannedModeratorCannotCreateSceneComment()
    {
    ...
    // User Updating
    public function testModeratorCanUpdateSceneComment()
    {
    ...
    public function testModeratorCanUpdateAnySceneComment()
    {
        $comment = Comment::factory()->create([
    ...
    public function testBannedModeratorCannotUpdateSceneComment()
    {
        $this->expectException(AuthorizationException::class);
    ...
    public function testBannedModeratorCannotUpdateAnySceneComment()
    {
        $this->expectException(AuthorizationException::class);
    ...
    // User Destroying
    public function testModeratorCanDestroySceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => $this->user->id
        ]);
    ...
    public function testModeratorCannotDestroyAnySceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => User::factory()->create()
        ]);
    ...
    public function testBannedModeratorCannotDestroySceneComment()
    {
        $this->expectException(AuthorizationException::class);
    ...
    public function testBannedModeratorCannotDestroyAnySceneComment()
    {
        $this->expectException(AuthorizationException::class);
    ...
    // User Deleting
    public function testModeratorCanDeleteSceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => $this->user->id
        ]);
    ...
    public function testModeratorCannDeleteAnySceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => User::factory()->create()
        ]);
    ...
    public function testBannedModeratorCannotDeleteSceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => $this->bannedUser->id
        ]);
    ...
    public function testBannedModeratorCannotDeleteAnySceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => User::factory()->create()
        ]);
    ...
    // User Restoring
    public function testModeratorCanRestoreSceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => $this->user->id
        ]);
    ...
    public function testModeratorCanRestoreAnySceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => User::factory()->create()
        ]);
    ...
    public function testBannedModeratorCanRestoreSceneComment()
    {
        $comment = Comment::factory()->create();
    ...
    public function testBannedModeratorCannotRestoreAnySceneComment()
    {
        $comment = Comment::factory()->create([
            'user_id' => User::factory()->create()
        ]);

<template>
    <div class="mb-3">
        ...
        <div class="input-group input-group-lg">
            ...
            <textarea v-bind="$attrs" v-bind:value="value" v-on:input="$emit('input', $event.target.value)" type="text" :name="name" :class="validationClass" class="form-control form-control-lg" :id="name" :aria-label="placeholder" :aria-describedby="name+'Label'">
            </textarea>
